            ...
            <div className={styles['lesson-info']}>
                ...
                {  
                    ...
                    <>
                        ...
                        {activity.gamma.map(component => <Component component={component}/>)}  
                    </> 
                }
                {  
                    ...
                    <>
                        <h2 className={styles['lesson-title']}>{activity.title}</h2> 
                        {activity.alpha.map(component => <Component component={component}/>)}  
                    </> 
                }
                {  
                    ...
                    <>
                        <h2 className={styles['lesson-title']}>{activity.title}</h2> 
                        {activity.beta.map(component => <Component component={component}/>)}  
                    </> 
                }
                {  
                    ...
                    <>
                        <h2 className={styles['lesson-title']}>{activity.title}</h2> 
                        {activity.delta.map(component => <Component component={component}/>)}  
                    </> 
                }
